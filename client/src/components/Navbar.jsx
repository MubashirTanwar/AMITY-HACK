  ...
  <nav class=" py-6 m-10 rounded-2xl bg-white/20 z-50 ">
    <div class="container px-4 mx-auto">
      <div class="flex items-center relative">
        <a class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 inline-block text-lg font-bold text-white" href="#">
          Nutritionist AI
        </a>
        <div>
          <button class="navbar-burger flex w-12 h-12 items-center justify-center bg-gray-800 hover:bg-gray-700 rounded-md transition duration-200">
